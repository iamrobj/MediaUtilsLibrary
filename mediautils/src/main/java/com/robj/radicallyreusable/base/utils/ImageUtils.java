...
public class ImageUtils {
    ...
    public static Observable<Optional<Bitmap>> getResizedImageFromUriObservable(final Context context, final Uri uri, final int desiredWidth, final int desiredHeight) {
        return Observable.<Optional<Bitmap>>create(new ObservableOnSubscribe<Optional<Bitmap>>() {
            @Override
            public void subscribe(ObservableEmitter<Optional<Bitmap>> e) throws Exception {
                try {
...
//                iv.setImageBitmap(bitmap);
            getResizedImageFromUriObservable(v.getContext(), imageUri, width, height)
                    ...
                    .subscribe(new Consumer<Optional<Bitmap>>() {
                        @Override
                        public void accept(Optional<Bitmap> bitmapOptional) throws Exception {
